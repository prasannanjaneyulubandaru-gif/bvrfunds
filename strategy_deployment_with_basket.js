...
<body class="min-h-screen bg-gray-50">
    ...
    <nav class="border-b border-gray-200 bg-white fixed top-0 left-0 right-0 z-50">
        <div class="px-4 md:px-6 py-3 md:py-4 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div class="w-7 h-7 md:w-8 md:h-8 bg-[#FE4A03] rounded-sm flex items-center justify-center">
                    <svg class="w-4 h-4 md:w-5 md:h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>
                    </svg>
                </div>
                <span class="text-lg md:text-xl font-bold text-gray-900">BVR Funds</span>
            </div>
            
            <!-- Profile Dropdown -->
            <div id="profileSection" class="hidden profile-dropdown">
                <button id="profileBtn" class="flex items-center gap-2 md:gap-3 hover:bg-gray-50 px-2 md:px-3 py-2 rounded-lg transition-colors">
                    ...
                    <div class="w-9 h-9 md:w-10 md:h-10 bg-[#FE4A03] rounded-full flex items-center justify-center">
                ...
                <div id="profileMenu" class="profile-menu hidden">
                    <div class="p-4 border-b border-gray-200">
                        ...
                        <div class="text-xs text-gray-500 mt-1" id="menuEmail"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9feaecfaeddffae7fef2eff3fab1fcf0f2">[email&#160;protected]</a></div>
                    </div>
                    <div class="p-3">
    ...
    <div id="mainContent" class="main-content">
        ...
        <!-- Login Page -->
        <div id="loginPage" class="min-h-screen flex items-center justify-center px-4 md:px-6 py-6">
            <div class="max-w-2xl w-full animate-slide-up">
                <div class="text-center mb-8 md:mb-12">
                    <h1 class="text-3xl md:text-5xl font-bold text-gray-900 mb-3 md:mb-4">Welcome Back</h1>
                    <p class="text-base md:text-lg text-gray-600">Enter your Zerodha Kite API credentials to continue</p>
                </div>

                <div class="bg-white rounded-2xl border-2 border-gray-200 p-6 md:p-8 shadow-sm">
                    <form id="credentialsForm" class="space-y-5 md:space-y-6">
                        <div>
                ...
                <!-- Feature Cards -->
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 mt-8 md:mt-12">
                    <div class="feature-card bg-white p-5 md:p-6 rounded-xl border-2 border-gray-200">
        ...
        <!-- Processing Token -->
        <div id="tokenPage" class="min-h-screen flex items-center justify-center px-4 md:px-6 hidden">
            <div class="max-w-xl w-full animate-fade-in">
                <div class="text-center mb-6 md:mb-8">
                    <h2 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Complete Login</h2>
                ...
                <div class="bg-white rounded-2xl border-2 border-gray-200 p-6 md:p-8 shadow-sm">
                    <div class="flex flex-col items-center gap-4">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-sm text-gray-600 break-all">Request Token: <span id="displayToken" class="mono text-[#FE4A03]"></span></p>
                        </div>
                    </div>
        ...
        <!-- Dashboard Page -->
        <div id="dashboardPage" class="p-4 md:p-8 hidden">
            ...
            <div class="bg-white border-2 border-gray-200 rounded-xl p-6 md:p-8">
                <h2 class="text-lg md:text-xl font-bold text-gray-900 mb-4">Getting Started</h2>
        ...
        <!-- Place Orders Page -->
        <div id="placeOrdersPage" class="p-4 md:p-8 hidden">
            <div class="mb-6 md:mb-8">
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Place Orders</h1>
                <p class="text-sm md:text-base text-gray-600">Create and manage your order basket</p>
            </div>

            <!-- Order Entry Form -->
            <div class="bg-white border-2 border-gray-200 rounded-xl p-4 md:p-6 mb-4 md:mb-6">
                <h2 class="text-lg md:text-xl font-bold text-gray-900 mb-4">Order Entry</h2>
                ...
                <div class="flex gap-4">
                    <button id="addOrderBtn" class="btn-primary text-white font-semibold px-6 py-3 rounded-lg flex-1 md:flex-none">
                        Add to Basket
                    </button>
                </div>
            </div>
            ...
            <div class="bg-white border-2 border-gray-200 rounded-xl p-4 md:p-6 mb-4 md:mb-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-3">
                    <h2 class="text-lg md:text-xl font-bold text-gray-900">Order Basket</h2>
            ...
            <div class="bg-white border-2 border-gray-200 rounded-xl p-4 md:p-6">
                <div class="flex flex-col sm:flex-row gap-3 md:gap-4">
                    <button id="checkMarginBtn" class="border-2 border-[#FE4A03] text-[#FE4A03] font-semibold px-6 py-3 rounded-lg hover:bg-[#FE4A03] hover:text-white transition-colors flex-1">
                        Check Margin
                    </button>
                    <button id="placeAllOrdersBtn" class="btn-success text-white font-semibold px-6 py-3 rounded-lg flex-1">
                        Place All Orders
                    </button>
                    <button id="refreshOrderStatusBtn" class="btn-secondary text-white font-semibold px-6 py-3 rounded-lg flex-1">
                        Refresh Status
                    </button>
                </div>
        ...
        <!-- Strategies Page -->
        <div id="strategiesPage" class="p-4 md:p-8 hidden">
            <div class="mb-4 md:mb-6">
                <h1 class="text-xl md:text-2xl font-bold text-gray-900 mb-1">Spread Strategies</h1>
                <p class="text-xs md:text-sm text-gray-600">Deploy spread strategies with futures</p>
            </div>

            <!-- Premium Range Configuration - COMPACT -->
            <div class="bg-white border-2 border-gray-200 rounded-xl p-4 mb-4">
                <h2 class="text-base md:text-lg font-bold text-gray-900 mb-3">Premium Range Configuration</h2>
            ...
            <div class="mt-4 bg-blue-50 border-2 border-blue-200 rounded-xl p-4">
                ...
                <div class="grid grid-cols-1 gap-3 text-xs text-blue-800">
                    <div>
        ...
        <div id="managePositionsPage" class="p-4 md:p-8 hidden">
            <div class="mb-6 md:mb-8">
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Manage Positions</h1>
                <p class="text-sm md:text-base text-gray-600">Monitor and manage your open positions</p>
            </div>
            ...
            <div class="bg-white border-2 border-gray-200 rounded-xl p-4 md:p-6 mb-4 md:mb-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-3">
                    <h2 class="text-lg md:text-xl font-bold text-gray-900">Active Positions</h2>
            ...
            <div id="positionActionsPanel" class="hidden">
                <div class="bg-white border-2 border-gray-200 rounded-xl p-4 md:p-6 mb-4 md:mb-6">
                    <h2 class="text-lg md:text-xl font-bold text-gray-900 mb-4">Position Actions</h2>
                    <div id="selectedPositionInfo"></div>
                    <div class="flex flex-col sm:flex-row gap-3 md:gap-4 mt-4">
                        <button id="trailSlBtn" class="btn-success text-white font-semibold px-6 py-3 rounded-lg flex-1">
                            🎯 Setup Trail SL
                        </button>
                        <button id="exitImmediatelyBtn" class="btn-danger text-white font-semibold px-6 py-3 rounded-lg flex-1">
                            ⚡ Exit Immediately
                        </button>
                    </div>
                </div>
                ...
                <div id="trailSlConfig" class="bg-white border-2 border-gray-200 rounded-xl p-4 md:p-6 mb-4 md:mb-6 hidden">
                    <h2 class="text-lg md:text-xl font-bold text-gray-900 mb-4">Trailing Stop Loss Configuration</h2>
                    <div id="trailConfigContent"></div>
                </div>

                <!-- Trail Status -->
                <div id="trailStatus" class="bg-white border-2 border-gray-200 rounded-xl p-4 md:p-6 hidden">
                    <h2 class="text-lg md:text-xl font-bold text-gray-900 mb-4">Trailing Status</h2>
                    <div id="trailStatusContent"></div>
                </div>
            </div>

            <!-- Messages -->
            <div id="positionMessages" class="bg-white border-2 border-gray-200 rounded-xl p-4 md:p-6"></div>
        </div>

        <!-- Chart Monitor Page -->
        <div id="chartMonitorPage" class="p-4 md:p-8 hidden">
            <div class="mb-6 md:mb-8">
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Chart Monitor</h1>
                <p class="text-sm md:text-base text-gray-600">Monitor candle strength and get email alerts</p>
            </div>
            ...
            <div class="bg-white border-2 border-gray-200 rounded-xl p-4 md:p-6 mb-4 md:mb-6">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
                    <div>
                        <h2 class="text-lg md:text-xl font-bold text-gray-900 mb-1">Monitor Status</h2>
                        <p class="text-xs md:text-sm text-gray-600">Checks every 5 minutes for strong candles</p>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3 md:gap-4">
                    <button id="startMonitorBtn" class="btn-primary text-white font-semibold px-6 py-3 rounded-lg flex-1">
                        Start Monitor
                    </button>
                    <button id="stopMonitorBtn" class="btn-secondary text-white font-semibold px-6 py-3 rounded-lg hidden flex-1">
                        Stop Monitor
                    </button>
                    <button id="checkNowBtn" class="border-2 border-gray-300 text-gray-700 font-semibold px-6 py-3 rounded-lg hover:bg-gray-50 flex-1">
                        Check Now
                    </button>
                    <button id="testEmailBtn" class="border-2 border-[#FE4A03] text-[#FE4A03] font-semibold px-6 py-3 rounded-lg hover:bg-[#FE4A03] hover:text-white transition-colors flex-1">
                        Test Email
                    </button>
                </div>
            </div>
            ...
            <!-- Activity Log -->
            <div class="bg-white border-2 border-gray-200 rounded-xl p-4 md:p-6">
                <h2 class="text-lg md:text-xl font-bold text-gray-900 mb-4">Activity Log</h2>
